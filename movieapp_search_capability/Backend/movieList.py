...
#on mongodb atlas, find the URI for your own collection                          
mongo = PyMongo(app)
...
#this is the get request for getting movie details
@app.route('/get_data', methods = ['GET'])
def get_data():
    try:
        #accesses the resList collection from the database
...
#this is for implementation of the search function, here <data> is the search term appended at end of the get request 
...
def search_data(data):
    try:
        ...
        #mongodb function for searching the required term
        ...
        #this is implemented to split words of the search term so as to match it according to words
