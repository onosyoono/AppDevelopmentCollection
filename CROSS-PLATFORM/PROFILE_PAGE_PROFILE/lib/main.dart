...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Flutter Profile Page'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //list of colors of the background
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            //this container loads profile image
            new Container(
                width: 180.0,
                height: 180.0,
            ...
            //this is just for commenting your work position
      ...
      backgroundColor: _colorsb[_currentIndex], //changes background color
    );
  }
}
